const en = {
  ...
  tasks: { title: 'Tasks', taskTitle: 'Task title', description: 'Description (optional)', selectProject: 'Select project', noTasks: 'No tasks yet' },
...
const ptBR: typeof en = {
  ...
  tasks: { title: 'Tarefas', taskTitle: 'Título da tarefa', description: 'Descrição (opcional)', selectProject: 'Selecione o projeto', noTasks: 'Nenhuma tarefa ainda' },
